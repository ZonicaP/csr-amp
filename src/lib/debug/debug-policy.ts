...
const membership =
  /\b(membership|member|account|customer|wash|payment|charge|charged|refund|plate|vehicle|plan|cancel|overdue|declin|card|invoice|subscription|reactivat|discount|bay|machine|visit|outstanding|twice|double)\b/i;
